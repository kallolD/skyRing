...
def simulate_data(params, psd1, psd2, L1, L2, omega_22_r, omega_22_i, omega_33_r, omega_33_i,
    ...
    for j in range(A.shape[0]):
        ...
        waveform2 = waveform2 + wvf_funcs[j](t+t0, f[j], gamma[j], A[j], Fp2, Fc2, swshs_p[j], swshs_m[j])
...
def simulate_data_full(params, gmst, psdH, psdL, L_H, L_L, omega_22_r, omega_22_i, omega_33_r, omega_33_i,
...
def ln_likelihood(data1, data2, params, L1, L2, omega_22_r, omega_22_i, omega_33_r, omega_33_i,
    ...
    # waveform1 = waveform1 + h22(t+t0, f[0], gamma[0], A[0], Fp1, Fc1, swsh22p, swsh22m)
    # waveform2 = waveform2 + h22(t+t0, f[0], gamma[0], A[0], Fp2, Fc2, swsh22p, swsh22m)

    # waveform1 = waveform1 + h33(t+t0, f[1], gamma[1], A[1], Fp1, Fc1, swsh33p, swsh33m)
    # waveform2 = waveform2 + h33(t+t0, f[1], gamma[1], A[1], Fp2, Fc2, swsh33p, swsh33m)
