...
def set_detector_locations(rH, rL):
    """
    Called from main.py to initialize the detector locations.
...
def ln_likelihood_full(dataH, dataL, params, gmst, L_H, L_L, omega_22_r, omega_22_i, omega_33_r, omega_33_i, T, srate, t0): 
